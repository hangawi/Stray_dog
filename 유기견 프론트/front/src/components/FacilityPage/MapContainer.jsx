...
function MapContainer() {
  ...
  useEffect(() => {
          ...
          (pos) => {
            ...
            fetch("/shelters.json")
              ...
              .then((data) => {
                ...
                setupShelterMarkers(withDistance, map, userPos);
              });
          },
          (error) => {
            ...
            fetch("/shelters.json")
              ...
              .then((data) => {
                ...
                setFiltered(withDistance);
                setClosestName(withDistance[0]?.name || "");
                setupShelterMarkers(withDistance, map, defaultPosition);
              });
          }
        );
      });
    ...
    function setupShelterMarkers(shelterList, map, userPos) {
      ...
      shelterList.forEach((shelter) => {
        const marker = new window.kakao.maps.Marker({
          ...
          image: new window.kakao.maps.MarkerImage(
            shelter.name === shelterList[0].name ? "/dog-icon1.png" : "/dog-icon.png",
          ...
          <div style="padding: 7px; font-size: 12px; position: relative;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px;">
              <a href="https://map.kakao.com/link/to/${encodeURIComponent(
                shelter.name
              )},${shelter.lat},${shelter.lng}" target="_blank" style="font-size: 15px; font-weight: bold; color:rgb(0, 140, 255); text-decoration: underline;">🧭 길찾기</a>
              <a href="/shelter-detail/${encodeURIComponent(
                shelter.id
        ...
        window.kakao.maps.event.addListener(marker, "click", () => {
          ...
          if (shelter.name === closestName && userPos) {
...
>
  ...
  >
    <div className="fixed-filter" style={{ marginBottom: "16px" }}>
